...
def main():
	pygame.init()
	surface = pygame.display.set_mode((1024, 1024//2))
	...
	labels = [pygame.font.SysFont(font, 20).render(font, 3, (randint(0, 255), randint(0, 255), randint(0, 255))) for font in pygame.font.get_fonts()[:50]]

	# Syntax highlighting
	con = Console.Console()
	height = renderLine(con.parseMarkup(code[0]), 16, 'kristenitc', (0,0))[0][0].get_size()[1]
	lines = [renderLine(con.parseMarkup(line), 16, 'kristenitc', (400, 20+n*height)) for n, line in enumerate(code)]
	...
	while True:
		...
		pygame.draw.circle(surface, (0xFF, 0x2C, 0x1C), (650, 300), 60, 5)
		# pygame.gfxdraw.aacircle(surface, (0xFF, 0x2C, 0x1C), (650, 300), 60, 5)
		pygame.draw.aaline(surface, (0x84, 0x9B, 0xF9), (650+60*cos(θ*0.5), 300+60*sin(θ*0.5)), (650+60*cos(θ*0.2), 300+60*sin(θ*0.2)), 5)
